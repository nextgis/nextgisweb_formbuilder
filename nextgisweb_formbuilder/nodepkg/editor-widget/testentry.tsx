...
function FormbuilderTest() {
  ...
  const handleTest = () => {
    const result = JSON.stringify(serializeData(store.inputsTree), null, ` `);
    ...
    <>
      ...
      <div style={{ display: "flex" }}>
        <div style={{ width: "60%" }}>
          ...
          <Button style={{ marginBottom: "6px" }} onClick={handleTest}>
        ...
        <div style={{ width: "40%" }}>
          ...
          <Button style={{ marginBottom: "6px" }} onClick={handleTestFields}>
